  ...
  return (
    <>
      ...
      <div ref={dragRef} className="twk-panel" data-omelette-chrome=""
        style={{ right: offsetRef.current.x, bottom: offsetRef.current.y } as React.CSSProperties}>
...
export function TweakRow({ label, value, children, inline = false }: { label: string; value?: any; children?: React.ReactNode; inline?: boolean }) {
  return (
    ...
    <TweakRow label={label}>
      <div className="twk-chips" role="radiogroup">
        {options.map((o, i) => {
          ...
          const [hero, ...rest] = colors as string[];
          ...
          return (
            <button key={i} type="button" className="twk-chip" role="radio"
              ...
              style={{ background: hero } as React.CSSProperties}
              onClick={() => onChange(o)}>
              {sup.length > 0 && (
                <span>
